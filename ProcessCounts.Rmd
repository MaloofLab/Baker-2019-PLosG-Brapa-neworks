...
save(counts.voom.CR, counts.voom.UN, file = "~/Box Sync/BrapaNetworks/CountsVoom_CR_UN.Rdata")
...
save(counts.voom.CR, counts.voom.UN, voom.fit.CR, voom.fit.UN, voom.topTable.CR, voom.topTable.UN, file="voom_CR_UN.Rdata")
```
