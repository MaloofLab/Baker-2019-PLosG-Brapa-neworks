...
eigen.annotated.small <- eigen.annotated %>% select(trait,eQTL_chrom=chrom, eQTL_start_bp, eQTL_end_bp, eQTL_start_cM, eQTL_end_cM, eigen_eQTL_candidate,ends_with("LOD"))
...
#### alternate threshold taking multiple traits into account
