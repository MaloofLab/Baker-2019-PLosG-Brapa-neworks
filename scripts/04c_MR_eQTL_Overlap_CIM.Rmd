...
dim(permtest.cim) 
```
This represents the 100 permutations for each gene.  So to get an experiment wise threshold I could take the max for each row and then to the 95% of that.
...
UN_annotated_small <- UN_annotated %>% select(MR_gene,MR_Cutoff,eQTL_chrom=chrom, eQTL_start_bp, eQTL_end_bp, eQTL_start_cM, eQTL_end_cM, eQTL_candidate,ends_with("LOD"))
