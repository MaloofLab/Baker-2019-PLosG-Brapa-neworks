...
Use different MR thresholds of 10 to 210 (absolute values) to build the network (genes with a correlation higher than the threshold were considered connected).  Then subset the network to take all genes "directly" connected to a FVT
