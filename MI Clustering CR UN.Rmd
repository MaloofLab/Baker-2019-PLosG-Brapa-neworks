...
blup.mr.graphs.CR <- lapply(cutoffs, get.mr.subgraph, mr.matrix = expr.blup.mr.CR, annotation= NA, neighborhood = colnames(blups.CR)[-1])
names(blup.mr.graphs.CR) <- sapply(blup.mr.graphs.CR, function(x) paste("blup.mr.graph.CR",x$cutoff,sep="."))

blup.mr.graphs.UN <- lapply(cutoffs, get.mr.subgraph, mr.matrix = expr.blup.mr.UN, annotation= NA, neighborhood = colnames(blups.UN)[-1])
