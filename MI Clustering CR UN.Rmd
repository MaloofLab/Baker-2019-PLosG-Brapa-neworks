...
perm.results.UN.100 <- sfSapply(permutations, function(p) {
...
Our networks are significant, but this is not helping set a threshold.  Try correlation with scale-free?
